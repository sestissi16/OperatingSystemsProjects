...
#define PM_SETBESTFIT       (PM_BASE + 48)
#define PM_SETWORSTFIT      (PM_BASE + 49)
#define PM_SETRANDOMFIT     (PM_BASE + 50)
#define PM_SETNEXTFIT       (PM_BASE + 51)

#define NR_PM_CALLS		52	/* highest number from base plus one */

/*
Below is the line added under the rest
#define PM_CYCLEMEMPOLICY	(PM_BASE + 48)
The line below is changed from the original above because of the addition
