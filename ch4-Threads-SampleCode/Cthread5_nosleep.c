...
sum = 0;
    ...
    mytime = time(NULL);
    printf("[runner]start time = %s",ctime(&mytime));
	...
	//printf("[runner] sum=%d\n", sum);
	mytime = time(NULL);
	printf("[runner]finish time = %s",ctime(&mytime));
...
sum2 = 0;
	...
	//printf("[runner2] sum2=%d\n", sum2);
        mytime = time(NULL);
        printf("[runner2]finish time = %s",ctime(&mytime));
...
sum3 = 0;
	...
	//printf("[runner3] sum3=%d\n", sum3);
        mytime = time(NULL);
        printf("[runner3]finish time = %s",ctime(&mytime));
...
sum4 = 0;
	...
	//printf("[runner4] sum4=%d\n", sum4);
        mytime = time(NULL);
        printf("[runner4] finish time = %s",ctime(&mytime));
...
void *runner5(void *param)
{
	...
	//printf("[runner5] sum5=%d\n", sum5);
        mytime = time(NULL);
        printf("[runner5]finish time = %s",ctime(&mytime));
